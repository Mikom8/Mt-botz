...
API_ID = int(environ.get('API_ID', '9131371'))
API_HASH = environ.get('API_HASH', '0293ab5d971d37d20c03bdc54b2f3dde')
BOT_TOKEN = environ.get('BOT_TOKEN', "5621184818:AAFXanrJTY7QtPp8f2Gk0hvyf2rqkbbmUkE")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2119653985'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5464284954').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '2071129713').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '2071129713') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mikomiky2020:2jAEbeuOutXeAtjt@cluster0.89kwozy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
